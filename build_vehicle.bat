...
del bin\Debug-windows-x86_64\driver\*.pdb >NUL
...
type nul>bin\Debug-windows-x86_64\driver\buildlock
...
del bin\Debug-windows-x86_64\driver\buildlock >NUL

echo Done compiling vehicle.
