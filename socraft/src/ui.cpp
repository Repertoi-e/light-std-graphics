...
void ui_main() {
    ...
    if (ImGui::BeginMenuBar()) {
        ...
        if (ImGui::IsItemHovered()) {
            ...
            ImGui::TextUnformatted("This is an awesome minecraft clone written entirely (expect ImGui) from scratch in order to battle-test my C++ standard library replacement.");
...
void ui_scene_properties() {
    ...
    }
    {
        ...
        if (ImGui::Button("Reset color")) Game->ClearColor = {0.0f, 0.017f, 0.099f, 1.0f};
    }
    ImGui::End();
}
