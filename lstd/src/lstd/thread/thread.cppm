...
// The mutex can't be recursive i.e. a program deadlocks if the thread
...
struct mutex {
    ...
    //
    // If the mutex is currently locked by the calling thread, the function trips an assert and produces a deadlock.
