...
// {
    ...
    namespace detail
    {
        template<class T, class U> using conv_t = typename types::enable_if<!types::is_same<T,U>, decltype(converter<T,U>{}(types::declval<U>()))>::type;
        ...
        template<class F, class... T> using ret_t = decltype(types::declval<F>()(types::declval<T>()...));
        ...
        template<class T, class... U> struct scalars<T,U...> : types::select<types::is_arithmetic<T>, scalars<U...>, empty>::type {};
        ...
        struct min    { template<class A, class B> constexpr auto operator() (A a, B b) const -> typename types::remove_reference_t<decltype(a<b ? a : b)> { return a<b ? a : b; } };
        struct max    { template<class A, class B> constexpr auto operator() (A a, B b) const -> typename types::remove_reference_t<decltype(a<b ? b : a)> { return a<b ? b : a; } };
        struct clamp  { template<class A, class B, class C> constexpr auto operator() (A a, B b, C c) const -> typename types::remove_reference_t<decltype(a<b ? b : a<c ? a : c)> { return a<b ? b : a<c ? a : c; } };
        struct select { template<class A, class B, class C> constexpr auto operator() (A a, B b, C c) const -> typename types::remove_reference_t<decltype(a ? b : c)>             { return a ? b : c; } };
    ...
    template<class F, class... A> using mm_apply_t = typename types::enable_if<detail::apply<F,void,A...>::mm, apply_t<F,A...>>::type;
    template<class F, class... A> using no_mm_apply_t = typename types::enable_if<!detail::apply<F,void,A...>::mm, apply_t<F,A...>>::type;
