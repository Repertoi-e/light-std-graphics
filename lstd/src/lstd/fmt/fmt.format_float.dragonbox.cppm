...
// It's used when formatting a float without a specified precision so we need to choose the shortest representation.
//

LSTD_BEGIN_NAMESPACE

constexpr u64 POW10_SIGNIFICANDS_64[] = {
...
// Computes upper 64 bits of multiplication of a 64-bit unsigned integer and a 128-bit unsigned integer.
...
// Computes upper 32 bits of multiplication of a 32-bit unsigned integer and a 64-bit unsigned integer.
always_inline u32 umul96_upper32(u32 x, u64 y) {
    return (u32) umul128_upper64(x, y);
}

// Computes middle 64 bits of multiplication of a 64-bit unsigned integer and a 128-bit unsigned integer.
...
// Computes lower 64 bits of multiplication of a 32-bit unsigned integer and a 64-bit unsigned integer.
...
constexpr divtest_table_entry<u32> DIVTEST_TABLE_FOR_POW5_32[] = {{0x00000001, 0xffffffff}, {0xcccccccd, 0x33333333}, {0xc28f5c29, 0x0a3d70a3}, {0x26e978d5, 0x020c49ba}, {0x3afb7e91, 0x0068db8b}, {0x0bcbe61d, 0x0014f8b5}, {0x68c26139, 0x000431bd}, {0xae8d46a5, 0x0000d6bf}, {0x22e90e21, 0x00002af3}, {0x3a2e9c6d, 0x00000897}, {0x3ed61f49, 0x000001b7}};

constexpr divtest_table_entry<u64> DIVTEST_TABLE_FOR_POW5_64[] = {{0x0000000000000001, 0xffffffffffffffff}, {0xcccccccccccccccd, 0x3333333333333333}, {0x8f5c28f5c28f5c29, 0x0a3d70a3d70a3d70}, {0x1cac083126e978d5, 0x020c49ba5e353f7c}, {0xd288ce703afb7e91, 0x0068db8bac710cb2}, {0x5d4e8fb00bcbe61d, 0x0014f8b588e368f0}, {0x790fb65668c26139, 0x000431bde82d7b63}, {0xe5032477ae8d46a5, 0x0000d6bf94d5e57a}, {0xc767074b22e90e21, 0x00002af31dc46118}, {0x8e47ce423a2e9c6d, 0x0000089705f4136b}, {0x4fa7f60d3ed61f49, 0x000001b7cdfd9d7b}, {0x0fee64690c913975, 0x00000057f5ff85e5}, {0x3662e0e1cf503eb1, 0x000000119799812d}, {0xa47a2cf9f6433fbd, 0x0000000384b84d09}, {0x54186f653140a659, 0x00000000b424dc35}, {0x7738164770402145, 0x0000000024075f3d}, {0xe4a4d1417cd9a041, 0x000000000734aca5}, {0xc75429d9e5c5200d, 0x000000000170ef54}, {0xc1773b91fac10669, 0x000000000049c977}, {0x26b172506559ce15, 0x00000000000ec1e4}, {0xd489e3a9addec2d1, 0x000000000002f394}, {0x90e860bb892c8d5d, 0x000000000000971d}, {0x502e79bf1b6f4f79, 0x0000000000001e39}, {0xdcd618596be30fe5, 0x000000000000060b}};

// Returns true iff x is divisible by pow(5, exp).
always_inline bool divisible_by_power_of_5(u32 x, s32 exp) {
    assert(exp <= 10 && "Exponent too big");
    return x * DIVTEST_TABLE_FOR_POW5_32[exp].ModInv <= DIVTEST_TABLE_FOR_POW5_32[exp].MaxQuot;
}

always_inline bool divisible_by_power_of_5(u64 x, s32 exp) {
    assert(exp <= 23 && "Exponent too big");
    return x * DIVTEST_TABLE_FOR_POW5_64[exp].ModInv <= DIVTEST_TABLE_FOR_POW5_64[exp].MaxQuot;
}

// f32:
// Replaces n by floor(n / pow(5, 1)) returning true iff n is divisible by pow(5, 1).
// Precondition: n <= 2 * pow(5, 2).
//
// f64:
// Replaces n by floor(n / pow(5, 2)) returning true iff n is divisible by pow(5, 2).
// Precondition: n <= 2 * pow(5, 3).
template <bool IS_F32>
bool check_divisibility_and_divide_by_pow5(u32 *n) {
    constexpr u32 magic_number        = IS_F32 ? 0xcccd : 0xa429;
    constexpr s32 bits_for_comparison = IS_F32 ? 16 : 8;
    constexpr u32 threshold           = IS_F32 ? 0x3333 : 0x0a;
    constexpr s32 shift_amount        = IS_F32 ? 18 : 20;
...
u32 small_division_by_pow10(u32 n) {
    constexpr u32 magic_number     = IS_F32 ? 0xcccd : 0xa3d8;
    constexpr s32 shift_amount     = IS_F32 ? 19 : 22;
    constexpr u32 divisor_times_10 = IS_F32 ? 100 : 1000;
...
always_inline u64 divide_by_10_to_kappa_plus_1(u64 n) { return umul128_upper64(n, 0x83126e978d4fdf3c) >> 9; }

//
// Various routines using pow of 10 cache
//

u64 get_cached_power_f32(s32 k) {
    constexpr s32 MIN_K = -31;
    constexpr s32 MAX_K = 46;

    assert(k >= MIN_K && k <= MAX_K && "k is out of range");
    return POW10_SIGNIFICANDS_64[k - MIN_K];
}

u128 get_cached_power_f64(s32 k) {
    constexpr s32 MIN_K = -292;
    constexpr s32 MAX_K = 326;
...
always_inline s32 remove_trailing_zeros(u32 *n) {
    ...
    constexpr u32 max_quotient1 = 0x33333333;
    constexpr u32 mod_inv2      = 0xc28f5c29;
    constexpr u32 max_quotient2 = 0x0a3d70a3;
...
always_inline s32 remove_trailing_zeros(u64 *n) {
    ...
    constexpr u32 mod_inv1      = 0xcccccccd;
    constexpr u32 max_quotient1 = 0x33333333;
    constexpr u64 mod_inv8      = 0xc767074b22e90e21;
    constexpr u64 max_quotient8 = 0x00002af31dc46118;
...
template <bool IS_F32>
bool is_endpoint_integer(auto two_f, s32 exponent, s32 minus_k) {
    constexpr s32 case_fc_pm_half_lower_threshold   = IS_F32 ? -1 : -2;
    constexpr s32 case_fc_pm_half_upper_threshold   = IS_F32 ? 6 : 9;
    constexpr s32 divisibility_check_by_5_threshold = IS_F32 ? 39 : 86;
...
bool is_center_integer(auto two_f, s32 exponent, s32 minus_k) {
    ...
    constexpr s32 case_fc_lower_threshold = IS_F32 ? -2 : -4;
    constexpr s32 case_fc_upper_threshold = IS_F32 ? 6 : 9;

    // Exponent for 5 is negative.
    if (exponent > divisibility_check_by_5_threshold) return false;

    if (exponent > case_fc_upper_threshold) return divisible_by_power_of_5(two_f, minus_k);
...
always_inline auto shorter_interval_case(s32 exponent) {
    ...
    if (exponent == SHORTER_INTERVAL_TIE_THRESHOLD) {
        result.Significand = result.Significand % 2 == 0 ? result.Significand : result.Significand - 1;
...
export auto dragonbox_format_float(types::is_floating_point auto x) {
    ...
    auto br = types::bit_cast<uint_t>(x);
    ...
    if (r > deltai) {
        ...
        if (r == 0 && !include_right_endpoint && is_endpoint_integer<IS_F32>(two_fr, exponent, minus_k)) {
            --result.Significand;
            r = BIG_DIVISOR;
            goto small_divisor_case_label;
        }
        ...
        if ((!include_left_endpoint || !is_endpoint_integer<IS_F32>(two_fl, exponent, minus_k)) && !cache_compute_mul_parity(two_fl, cache, beta_minus_1)) {
            goto small_divisor_case_label;
        }
    }
...
small_divisor_case_label:
    ...
    if ((dist & mask) == 0) {
        ...
        if (check_divisibility_and_divide_by_pow5<IS_F32>(&dist)) {
            ...
            // is an even number
            if (cache_compute_mul_parity(two_fc, cache, beta_minus_1) != approx_y_parity) {
                --result.Significand;
            } else {
