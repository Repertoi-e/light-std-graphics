...
//
// We don't provide this anymore, as explained above.
//

struct arena_allocator_data {
    // Linked list of pools, see arena_allocator.cpp for example usage of the helper routines we provide to manage this.
...
//
// Memory functions (malloc, calloc, realloc, free) are provided (and overriden) by default.
...
// They are named the same way for simplicity sake.
//
