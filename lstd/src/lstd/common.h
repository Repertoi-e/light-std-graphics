...
export import "common/atomic.h";
export import "common/bits.h";
export import "common/debug_break.h";
export import "common/math.h";
export import "common/numeric_info.h";
export import "common/sequence.h";
export import "common/u128.h";
export import "common/defer_assert_for.h";
...
*/
export import "vendor/cephes/maths_cephes.h";

export constexpr f64 PI  = 3.1415926535897932384626433832795;
export constexpr f64 TAU = 6.283185307179586476925286766559;
