...
// #include <stdio.h>      // FILE*, sscanf                                         :WEMODIFIEDIMGUI:
// #include <stdlib.h>     // NULL, malloc, free, qsort, atoi, atof                 :WEMODIFIEDIMGUI:
// #include <math.h>       // sqrtf, fabsf, fmodf, powf, floorf, ceilf, cosf, sinf  :WEMODIFIEDIMGUI:
...
namespace ImGui
{
    ...
    // Logging/Capture
    IMGUI_API void          LogBegin(ImGuiLogType type, int auto_open_depth);           // -> BeginCapture() when we design float2 api, for now stay under the radar by using the old name.
