...
void platform_state_init() {
    // This prepares the global thread-local immutable Context variable (see "lstd/common/context.h")
    ...
    LSTD_NAMESPACE::win64_monitor_init();
    LSTD_NAMESPACE::win64_window_init();
}
...
static BOOL __cdecl dllmain_crt_process_detach(bool const is_terminating) {
    ...
    LSTD_NAMESPACE::win64_monitor_uninit();
    LSTD_NAMESPACE::win64_window_uninit();
    LSTD_NAMESPACE::internal::platform_uninit_state();
