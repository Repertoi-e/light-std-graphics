...
// kernel32.dll.
#if defined _SCRT_ENCLAVE_BUILD || defined _CRT_APP || defined _CRT_WINDOWS_USE_VISTA_TSS || (!defined _CRT_WINDOWS && (defined _ONECORE || defined _M_ARM || defined _M_ARM64))
...
static int __cdecl __scrt_initialize_thread_safe_statics() noexcept {
    ...
    //     __scrt_fastfail(FAST_FAIL_FATAL_APP_EXIT);
    // }
    LSTD_NAMESPACE::exit_schedule(__scrt_uninitialize_thread_safe_statics);
    return 0;
}
